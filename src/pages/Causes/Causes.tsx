    ...
    <Layout>
      <div className="-mt-24 ">
            ...
            <div className="text-white z-30 md:w-1/2 p-8 bg-opacity-25 bg-black flex justify-center items-center ">
              <div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <p className="text-gray-200">1 march 2022</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container bg-white mx-auto">
          <div className="md:w-1/2 mx-auto my-14 bg-gray-200 rounded-full ">
            <div
          ...
          <div className="my-5 md:grid md:grid-cols-3 gap-4">
            <div className="md:col-span-2  border-2 p-4">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt
                culpa iure at, est quam repellat dolore distinctio repudiandae
                expedita aspernatur fugit architecto odit odio iste id eius.
                Necessitatibus, quisquam. Doloribus vitae ratione nesciunt natus
                animi eligendi ab quaerat quod, quo sapiente ad ut cum error nam
                qui dicta quasi dolor praesentium sed ea earum fugit unde
                necessitatibus! Illo voluptatem dicta dignissimos. Reiciendis
                asperiores corrupti natus et vero, quaerat repellendus
                doloremque! Fuga ratione totam accusantium praesentium mollitia
                recusandae reiciendis, facere obcaecati doloremque eaque
                temporibus magnam sit sunt, a deleniti eveniet repellendus et
                accusamus? Magnam
              </p>
            ...
            <div className=" border-2 hidden md:block">
              ...
              <div className="p-3 bottom-2">
                <div className="flex justify-between my-2 bg-gray-300 p-4 rounded-br-3xl rounded-tl-3xl">
                  <p>Total Post :</p>
                  <p>5</p>
                </div>
                <div className="flex justify-between my-2 bg-gray-300 p-4 rounded-br-3xl rounded-tl-3xl">
